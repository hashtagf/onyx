...
function buildItems(
  ...
  if (!isCurator) {
    ...
    add(SECTIONS.INTEGRATIONS, ADMIN_ROUTES.TELEGRAM_BOTS);
    add(SECTIONS.INTEGRATIONS, ADMIN_ROUTES.LINE_BOTS);
    if (hooksEnabled) {
  ...
  if (!isCurator) {
    ...
    add(SECTIONS.PERMISSIONS, ADMIN_ROUTES.SERVICE_ACCOUNTS_CE);
  ...
  if (!isCurator) {
    ...
    add(SECTIONS.USAGE, ADMIN_ROUTES.USAGE_REPORT);
    add(SECTIONS.USAGE, ADMIN_ROUTES.AI_IMPROVEMENT);
